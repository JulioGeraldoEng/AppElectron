...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const form = document.getElementById('form-cadastrar-funcionario');
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      const resposta = await fetchComToken('/api/admin/cadastrar-funcionario', {
        method: 'POST',
      ...
      if (resposta?.success) {
        ...
        mensagem.textContent = resposta.message || 'Erro ao cadastrar funcionário.';
        mensagem.style.color = 'red';
      }
    } catch (err) {
